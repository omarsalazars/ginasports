...
<body>
	<?php include 'controller/banner.controller.php'; ?>
	<div class="container shadow col-lg-4 col-center mt-5 p-5" id="container">
		<h1 class="mb-5" style="color: black;">Configuración</h1>
		<form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario form-inline row p-2" name="config">
